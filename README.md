...
```
git clone https://github.com/gitTechhive/node-sample-dashboard-1.git
```
2. Navigate to the project directory:
```
cd node-sample-dashboard-1
```
...
This command will start the development server and automatically open your default browser to [localhost:4001](http://localhost:4001/).
