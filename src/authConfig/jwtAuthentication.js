...
const auth = async (req, res, next) => {
    try {
        ...
        const nonSecurePaths = ['/captcha/scheduller', '/captcha/generate', '/captcha/verification', '/captcha/reGenerate', '/test', '/generateOtpForRegistration', '/verifyOtpForRegistration', '/login', '/master/countryCodes']; // Define non-secure paths
